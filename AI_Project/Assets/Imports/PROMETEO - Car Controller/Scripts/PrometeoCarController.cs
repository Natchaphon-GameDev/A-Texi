  ...
  //CAR SETUP
    ...
    public void CarSpeedUI(){
      ...
      if(useUI){
          try{
            ...
            //Debug Car Accelerator Display
            carSpeedText.text = carRigidbody.velocity.sqrMagnitude.ToString("0");
    ...
    public void DriftCarPS(){
      ...
      if(useEffects){
        ...
        try{
          if((isTractionLocked || Mathf.Abs(localVelocityX) > 8f) && Mathf.Abs(carSpeed) > 17f){
